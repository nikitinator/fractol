...
/*   Updated: 2018/03/14 14:58:52 by snikitin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fractol.h"

t_break	get_itr(t_cmplx iter(t_cmplx z, t_cmplx z2, t_cmplx to_add), t_cmplx c,
		short max_iterations, t_cmplx to_add)
{
	t_break point;
	t_cmplx z;
